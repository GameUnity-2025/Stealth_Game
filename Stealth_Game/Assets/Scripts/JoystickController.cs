...
namespace PinePie.SimpleJoystick
{
    ...
    public class JoystickController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public bool IsDragging => isDragging; // Property mới để Player kiểm tra
        // ===============================================================
        ...
        {
            Debug.Log("Joystick is dragging!");

            // Ensure dragging starts inside the joystick range
            ...
            // Adjust joystick base position for dynamic mode
